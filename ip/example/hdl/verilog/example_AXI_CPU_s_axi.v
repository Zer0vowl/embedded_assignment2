...
#(parameter
    ...
    input  wire [9:0]                    in1_address0,
    input  wire                          in1_ce0,
    output wire [31:0]                   in1_q0,
    input  wire [9:0]                    in2_address0,
    input  wire                          in2_ce0,
...
localparam
    ...
    ADDR_IER        = 14'h0008,
    ADDR_ISR        = 14'h000c,
    ADDR_IN1_BASE   = 14'h1000,
    ADDR_IN1_HIGH   = 14'h1fff,
    ADDR_IN2_BASE   = 14'h2000,
    ADDR_IN2_HIGH   = 14'h2fff,
    ADDR_OUT_R_BASE = 14'h3000,
    ADDR_OUT_R_HIGH = 14'h3fff,
    WRIDLE          = 2'd0,
    WRDATA          = 2'd1,
    WRRESP          = 2'd2,
    WRRESET         = 2'd3,
...
assign int_in1_address1   = ar_hs? raddr[11:2] : waddr[11:2];
assign int_in1_ce1        = ar_hs | (int_in1_write & WVALID);
assign int_in1_we1        = int_in1_write & w_hs;
...
assign int_in2_address1   = ar_hs? raddr[11:2] : waddr[11:2];
assign int_in2_ce1        = ar_hs | (int_in2_write & WVALID);
assign int_in2_we1        = int_in2_write & w_hs;
...
assign int_out_r_address1 = ar_hs? raddr[11:2] : waddr[11:2];
...
module example_AXI_CPU_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
