...
reg    ap_ready;
wire   [9:0] in1_address0;
reg    in1_ce0;
wire   [31:0] in1_q0;
wire   [9:0] in2_address0;
reg    in2_ce0;
wire   [31:0] in2_q0;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        i_reg_99 <= 10'd0;
    end else if (((icmp_ln18_fu_116_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_reg_99 <= add_ln18_fu_110_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln18_fu_116_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_cast_reg_144[9 : 0] <= i_cast_fu_122_p1[9 : 0];
    end
end
...
always @ (*) begin
    if ((icmp_ln18_fu_116_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln18_reg_140 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        out_r_we0 = 1'b1;
    end else begin
        out_r_we0 = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((icmp_ln18_fu_116_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((icmp_ln18_fu_116_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
assign add_ln18_fu_110_p2 = (i_reg_99 + 10'd1);
...
assign i_cast_fu_122_p1 = i_reg_99;

assign icmp_ln18_fu_116_p2 = ((i_reg_99 == 10'd1000) ? 1'b1 : 1'b0);

assign in1_address0 = i_cast_fu_122_p1;

assign in2_address0 = i_cast_fu_122_p1;

assign out_r_address0 = i_cast_reg_144;

assign out_r_d0 = (in2_q0 + in1_q0);

always @ (posedge ap_clk) begin
    i_cast_reg_144[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
end
